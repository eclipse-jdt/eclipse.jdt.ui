...
import org.eclipse.jdt.internal.corext.refactoring.code.RewriteMethodInvocationsRefactoring;
import org.eclipse.jdt.internal.corext.refactoring.util.RefactoringASTParser;

public class RewriteMethodInvocationsTests extends AbstractSelectionTestCase {
	private static RewriteMethodInvocationsTestSetup fgTestSetup;
	
	public RewriteMethodInvocationsTests(String name) {
		super(name, true);
	}

	public static Test suite() {
		fgTestSetup= new RewriteMethodInvocationsTestSetup(new TestSuite(RewriteMethodInvocationsTests.class));
		return fgTestSetup;
	}
	...
	protected String getResourceLocation() {
		return "RewriteMethodInvocationsWorkspace/RewriteMethodInvocations/";
	}
	...
	private void performTestRewriteInvocations(IPackageFragment packageFragment, String id, int mode, String outputFolder) throws Exception {
		...
		CompilationUnit compilationUnit= new RefactoringASTParser(AST.JLS3).parse(unit, true);
		...
		RewriteMethodInvocationsRefactoring refactoring= RewriteMethodInvocationsRefactoring.create(unit, compilationUnit, selection[0], selection[1]);
