...
public class RenameMethodPerfTests2 extends RefactoringPerformanceTestCase {
	...
	public void test_10_100() throws Exception {
		ICompilationUnit cunit= CodeGenerator.generateMethodRenameSources(fTestProject, 10, 100);
		executeRefactoring(cunit);
	}
	
	public void test_10_1000() throws Exception {
		ICompilationUnit cunit= CodeGenerator.generateMethodRenameSources(fTestProject, 10, 1000);
		executeRefactoring(cunit);
	}
