 ...
 */
class NewSelectionListenerWithASTManager {
	
	private static NewSelectionListenerWithASTManager fgDefault;
	
	/**
	 * @return Returns the default manager instance.
	 */
	public static NewSelectionListenerWithASTManager getDefault() {
		if (fgDefault == null) {
			fgDefault= new NewSelectionListenerWithASTManager();
		}
		return fgDefault;
	}
	...
	private NewSelectionListenerWithASTManager() {
