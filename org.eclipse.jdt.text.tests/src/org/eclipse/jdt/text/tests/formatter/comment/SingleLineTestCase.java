...
public class SingleLineTestCase extends CommentTestCase {
	...
	public void testClearBlankLines1() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "5"); //$NON-NLS-1$
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_CLEARBLANKLINES, Boolean.toString(false));
	...
	public void testCommentNls2() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "1"); //$NON-NLS-1$
		assertEquals("//$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$", testFormat("//$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$")); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void testCommentNls5() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "-2"); //$NON-NLS-1$
	...
	public void testCommentWrapping3() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "32"); //$NON-NLS-1$
	...
	public void testHeaderComment1() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_FORMATHEADER, Boolean.toString(false));
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "12"); //$NON-NLS-1$
	...
	public void testHeaderComment2() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_FORMATHEADER, Boolean.toString(false));
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "24"); //$NON-NLS-1$
	...
	public void testIllegalLineLength2() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "-16"); //$NON-NLS-1$
	...
	public void testMultipleComments3() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "11"); //$NON-NLS-1$
	...
	public void testNoFormat1() {
		...
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "1");
