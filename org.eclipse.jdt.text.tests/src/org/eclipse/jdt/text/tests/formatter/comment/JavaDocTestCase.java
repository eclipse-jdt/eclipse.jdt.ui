...
public class JavaDocTestCase extends CommentTestCase {
	...
	public void testMultiLineCommentLineBreakBeforeImmutableRegions1() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "22"); //$NON-NLS-1$
	...
	public void testMultiLineCommentLineBreakBeforeImmutableRegions2() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_LINELENGTH, "21"); //$NON-NLS-1$
		String input= PREFIX + DELIMITER + INFIX + "a <code>test</code>" + DELIMITER + POSTFIX; //$NON-NLS-1$
	...
	public void testMultiLineCommentBlankLineBeforeJavadoctags1() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_SEPARATEROOTTAGS, "false"); //$NON-NLS-1$
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_CLEARBLANKLINES, "false"); //$NON-NLS-1$
	...
	public void testMultiLineCommentBlankLineBeforeJavadoctags2() {
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_SEPARATEROOTTAGS, "true"); //$NON-NLS-1$
		setUserOption(CommentFormatterPreferenceConstants.FORMATTER_COMMENT_CLEARBLANKLINES, "true"); //$NON-NLS-1$
