...
public class PrimitiveShortRatherThanWrapperFixCore extends CompilationUnitRewriteOperationsFixCore {
	public static final class PrimitiveShortRatherThanWrapperFinder extends AbstractPrimitiveRatherThanWrapperFinder {
	...
	public static ICleanUpFixCore createCleanUp(final CompilationUnit compilationUnit) {
		...
		PrimitiveShortRatherThanWrapperFinder finder= new PrimitiveShortRatherThanWrapperFinder(operations);
