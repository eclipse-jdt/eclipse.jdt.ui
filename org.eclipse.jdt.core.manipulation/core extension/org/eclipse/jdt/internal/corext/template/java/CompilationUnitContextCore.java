 ...
 */
public class CompilationUnitContextCore extends DocumentTemplateContext implements ICompilationUnitContext {
	 ...
	 */
	public CompilationUnitContextCore(TemplateContextType type, IDocument document, int completionOffset, int completionLength, ICompilationUnit compilationUnit) {
	 ...
	 * @since 3.2
	 */
	public CompilationUnitContextCore(TemplateContextType type, IDocument document, Position completionPosition, ICompilationUnit compilationUnit) {
