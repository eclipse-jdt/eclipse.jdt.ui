...
/**
 * Refactoring contribution for the rename module refactoring.
 *
 * @since 3.24
 */
public final class RenameModuleRefactoringContribution extends JavaUIRefactoringContribution {
	...
	public Refactoring createRefactoring(JavaRefactoringDescriptor descriptor, RefactoringStatus status) {
		...
		RenameModuleProcessor processor= new RenameModuleProcessor(arguments, status);
		return new RenameRefactoring(processor);
	}

	@Override
	public RefactoringDescriptor createDescriptor() {
		return RefactoringSignatureDescriptorFactory.createRenameJavaElementDescriptor(IJavaRefactorings.RENAME_MODULE);
	}
