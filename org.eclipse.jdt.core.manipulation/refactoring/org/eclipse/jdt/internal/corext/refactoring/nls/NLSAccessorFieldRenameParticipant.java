...
public class NLSAccessorFieldRenameParticipant extends RenameParticipant {
	...
	public RefactoringStatus checkConditions(IProgressMonitor pm, CheckConditionsContext context) throws OperationCanceledException {
		...
		try {
			...
			try {
				manager.connect(propertyFilePath, LocationKind.IFILE, SubMonitor.convert(pm, 25));
				...
				manager.disconnect(propertyFilePath, LocationKind.IFILE, SubMonitor.convert(pm, 25));
			}
