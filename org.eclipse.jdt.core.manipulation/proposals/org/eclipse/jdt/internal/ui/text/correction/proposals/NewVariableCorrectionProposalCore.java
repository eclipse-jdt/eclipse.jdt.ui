 ...
 *     Red Hat Inc. - Body moved from org.eclipse.jdt.internal.ui.text.correction.proposals.NewVariableCorrectionProposal
 *******************************************************************************/
...
public class NewVariableCorrectionProposalCore extends LinkedCorrectionProposalCore {
	...
	private ASTRewrite doAddParam(CompilationUnit cu) {
		...
		if (decl instanceof MethodDeclaration) {
			...
			if (javadoc != null) {
				...
				JavadocTagsSubProcessorCore.insertTag(tagsRewriter, newTagElement, leadingNames);
			}
