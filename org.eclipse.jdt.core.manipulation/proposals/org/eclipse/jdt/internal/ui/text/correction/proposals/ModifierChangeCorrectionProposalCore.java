 ...
 *     Red Hat Inc. - Body moved from org.eclipse.jdt.internal.ui.text.correction.proposals.ModifierChangeCorrectionProposal
 *******************************************************************************/
					...
					if (methodDecl.getBody() == null && methodBinding != null && Modifier.isAbstract(methodBinding.getModifiers()) && Modifier.isStatic(fIncludedModifiers)) {
						...
						if (returnType != null) {
							...
							if (expression != null) {
								...
								bodyStatement= ASTNodes.asFormattedString(returnStatement, 0, delimiter, FormatterProfileManagerCore.getProjectSettings(unit.getJavaProject()));
							}
						}
