...
public class TestCaseClassLoader extends ClassLoader {
	...
	/**
	 * Constructs a TestCaseLoader. It scans the class path and the excluded package
	 * paths
	 */
	...
	private void readExcludedPackages() {
		...
		for (String defaultExclusion : defaultExclusions)
			fExcluded.addElement(defaultExclusion);
