...
public class CallHierarchyViewPartContentDescriptionTest {
	...
	private static IType fType;

	private CallHierarchyViewPart fViewPart;

	@BeforeAll
	public static void setUpAll() throws CoreException {
		fProject= JavaProjectHelper.createJavaProject(CallHierarchyViewPartContentDescriptionTest.class.getSimpleName(), "bin");
		...
		fType= compilationUnit.findPrimaryType();
	}
	...
	public void setUp() {
		...
		fViewPart= CallHierarchyUI.openView(new IMember[] { fType }, window);
	}

	@AfterEach
	public void tearDown() throws Exception {
		if (fViewPart != null) {
			fViewPart.getSite().getPage().hideView(fViewPart);
		}
	...
	@Test
	public void testContentDescriptionTestCodeOnlyWithFilterPatterns() {
		String filters= "A,B,C";
		...
		String expected= CallHierarchyMessages.CallHierarchyViewPart_scopeDescriptionWithFilters_inTestCode + " " + SCOPE_DESCRIPTION + " "
				+ Messages.format(CallHierarchyMessages.CallHierarchyViewPart_scopeDescriptionWithFilters_activeFilters, filters);
		assertThat(fViewPart.getContentDescription()).endsWith(expected);
	}
	...
	@Test
	public void testContentDescriptionMainCodeOnlyWithFilterPatterns() {
		String filters= "A,B,C";
