...
public class PackagesViewContentProviderTests extends TestCase {
	...
	public void testGetChildrenProjectWithSourceFolders() throws Exception{
		...
		//create a compound elment for default package
	...
	public void testGetChildrentMidLevelFragmentNotCompound() throws Exception{
		//initialise map
	...
	public void testGetChildrenCompoundElement() throws Exception{
		...
		//create a compound element who is the child of cp
	...
	public void testGetChildrenCompoundElement2() throws Exception{
	...
	public void testGetParentTopLevelCompoundElement() throws Exception{
	...
	public void testGetParentPackageFragmentWithCompoundElementParent() throws Exception{
		
		LogicalPackage cp= new LogicalPackage(fPack31);
		cp.add(fPack32);
		cp.add(fInternalPack3);
		
		//this must be done to ensure mapping (compound elements don't need to be created on the way up)
		fProvider.getChildren(fJProject2);
		
		Object parent= fProvider.getParent(fPack81);
		boolean assertion= (parent instanceof LogicalPackage);
		assertTrue("Wrong parent found for a top level LogicalPackage", assertion && canFindEqualCompoundElement(cp, new Object[]{parent}));//$NON-NLS-1$
	}
	
	public void testGetParentCompoundElementWithCompoundElementParent() throws Exception{
		...
		Object parent= fProvider.getParent(cp);
		boolean assertion= (parent instanceof LogicalPackage);
		assertTrue("Wrong parent found for a top level LogicalPackage", assertion && canFindEqualCompoundElement(parentCp, new Object[]{parent}));//$NON-NLS-1$
	}
	...
	public void testGetParentPFwithProjectFocus(){
		...
		Object parent= fProvider.getParent(fPack41);	
		boolean assertion= (parent instanceof LogicalPackage);
		assertTrue("Wrong parent found for a mid level Fragment with Root Focus", assertion && canFindEqualCompoundElement(cp,new Object[]{parent}));		//$NON-NLS-1$
	}
