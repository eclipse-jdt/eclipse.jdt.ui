...
public class JavaHeuristicScannerTest extends TestCase {
	...
	public void testPrevIndentationUnit3() {
		fDocument.set("\tint a;\n" +			"\tif (true)\n" +			"\t\treturn a;");
...
//		Assert.assertEquals(1, pos);
	...
	public void testPrevIndentation1() {
		...
		String indent= fScanner.getReferenceIndentation(18);
	...
	public void testPrevIndentation2() {
		...
		String indent= fScanner.getReferenceIndentation(28);
		Assert.assertEquals("\t", indent);
	}
	...
	public void testPrevIndentation3() {
		...
		String indent= fScanner.getReferenceIndentation(29);
		Assert.assertEquals("\t", indent);
	}
	...
	public void testPrevIndentation5() {
		...
		String indent= fScanner.getReferenceIndentation(30);
		Assert.assertEquals("\t", indent);
	}
	
	public void testPrevIndentation6() {
		// TODO parameter declaration - might want alignment with parenthesis 
		fDocument.set("\tvoid proc (int par1, int par2\n");
	...
	public void testPrevIndentation7() {
		...
		String indent= fScanner.getReferenceIndentation(fDocument.getLength());
		Assert.assertEquals("\t\t", indent);
	}
	...
	public void testIndentation1() {
		...
		String indent= fScanner.computeIndentation(18);
		Assert.assertEquals("\t\t", indent);
	}
	...
	public void testIndentation2() {
		...
		String indent= fScanner.computeIndentation(28);
		Assert.assertEquals("\t\t", indent);
	}
	...
	public void testIndentation3() {
		...
		String indent= fScanner.computeIndentation(29);
		Assert.assertEquals("\t\t", indent);
	}
	...
	public void testIndentation5() {
		...
		String indent= fScanner.computeIndentation(30);
		Assert.assertEquals("\t", indent);
	}
	...
	public void testIndentation27() {
		...
		String indent= fScanner.computeIndentation(8);
		Assert.assertEquals("\t", indent);
	}
	...
	public void testIndentation28() {
		...
		int i= fScanner.findReferencePosition(fDocument.getLength() - 1);
		Assert.assertEquals(1, i);
		String indent= fScanner.computeIndentation(fDocument.getLength() - 1);
		Assert.assertEquals("\t", indent);
	}
