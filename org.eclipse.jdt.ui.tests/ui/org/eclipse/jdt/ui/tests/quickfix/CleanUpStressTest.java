...
public class CleanUpStressTest extends TestCase {
    ...
    static {
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * Base class for all test runners.\n");
        buf.append(" * This class was born live on stage in Sardinia during XP2000.\n");
        buf.append(" */\n");
        ...
        buf.append("        final FileOutputStream fos= new FileOutputStream(BaseTestRunner.getPreferencesFile());\n");
        buf.append("        try {\n");
        ...
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public synchronized void addFailure(final Test test, final AssertionFailedError t) {\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Returns the Test corresponding to the given suite. This is\n");
        buf.append("     * a template method, subclasses override runFailed(), clearStatus().\n");
        buf.append("     */\n");
        ...
        buf.append("        try {\n");
        buf.append("            suiteMethod= testClass.getMethod(BaseTestRunner.SUITE_METHODNAME, new Class[0]);\n");
        buf.append("         } catch(final Exception e) {\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Processes the command line arguments and\n");
        buf.append("     * returns the name of the suite class to run or null\n");
        buf.append("     */\n");
        ...
        buf.append("        if ((BaseTestRunner.fgMaxMessageLength != -1) && (s.length() > BaseTestRunner.fgMaxMessageLength)) {\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Override to define how to handle a failed loading of\n");
        buf.append("     * a test suite.\n");
        buf.append("     */\n");
        ...
        buf.append("     */\n");
        buf.append("    protected Class loadSuiteClass(final String suiteClassName) throws ClassNotFoundException {\n");
        ...
        buf.append("             BaseTestRunner.setPreferences(new Properties(BaseTestRunner.getPreferences()));\n");
        ...
        buf.append("        final String[] patterns= new String[] {\n");
        buf.append("            \"junit.framework.TestCase\", //$NON-NLS-1$\n");
        ...
        buf.append("\n");
        buf.append("     static {\n");
        buf.append("         BaseTestRunner.fgMaxMessageLength= BaseTestRunner.getPreference(\"maxmessage\", BaseTestRunner.fgMaxMessageLength); //$NON-NLS-1$\n");
        buf.append("     }\n");
        buf.append("\n");
        buf.append("}");
        ...
        buf.append("        Assert.assertEquals(this.fFiltered, BaseTestRunner.getFilteredTrace(this.fUnfiltered));\n");
        buf.append("    }\n");
        buf.append("}");
        ...
        buf.append("        try {\n");
        buf.append("            Assert.assertEquals(Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY, 0.0);\n");
        buf.append("        } catch (final AssertionFailedError e) {\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        buf.append("        Assert.fail();\n");
        ...
        buf.append("        Assert.assertEquals(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, 0.0);\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testAssertNegInfinityEqualsInfinity() {\n");
        buf.append("        Assert.assertEquals(Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, 0.0);\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("}\n");
        buf.append("");
        ...
        buf.append("\n");
        buf.append("    /* In the tests that follow, we can't use standard formatting\n");
        buf.append("     * for exception tests:\n");
        buf.append("     *     try {\n");
        buf.append("     *         somethingThatShouldThrow();\n");
        buf.append("     *         fail();\n");
        buf.append("     *     catch (AssertionFailedError e) {\n");
        buf.append("     *     }\n");
        buf.append("     * because fail() would never be reported.\n");
        buf.append("     */\n");
        ...
        buf.append("        public ThrowRuntimeExceptionTestCase(final String name, final Class exception) {\n");
        buf.append("            super(name, exception);\n");
        buf.append("        }\n");
        buf.append("        public void test() {\n");
        ...
        buf.append("        final ExceptionTestCase test= new ThrowExceptionTestCase(\"test\", IndexOutOfBoundsException.class); //$NON-NLS-1$\n");
        ...
        buf.append("        final ExceptionTestCase test= new ThrowRuntimeExceptionTestCase(\"test\", IndexOutOfBoundsException.class); //$NON-NLS-1$\n");
        buf.append("        final TestResult result= test.run();\n");
        buf.append("        Assert.assertEquals(1, result.runCount());\n");
        buf.append("        Assert.assertEquals(1, result.errorCount());\n");
        buf.append("    }\n");
        buf.append("    public void testNoException() {\n");
        buf.append("        final ExceptionTestCase test= new ThrowNoExceptionTestCase(\"test\", Exception.class); //$NON-NLS-1$\n");
        buf.append("        final TestResult result= test.run();\n");
        buf.append("        Assert.assertEquals(1, result.runCount());\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A Decorator for Tests. Use TestDecorator as the base class\n");
        buf.append(" * for defining new test decorators. Test decorator subclasses\n");
        buf.append(" * can be introduced to add behaviour before or after a test\n");
        buf.append(" * is run.\n");
        buf.append(" *\n");
        buf.append(" */\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A <code>TestResult</code> collects the results of executing\n");
        buf.append(" * a test case. It is an instance of the Collecting Parameter pattern.\n");
        buf.append(" * The test framework distinguishes between <i>failures</i> and <i>errors</i>.\n");
        buf.append(" * A failure is anticipated and checked for with assertions. Errors are\n");
        buf.append(" * unanticipated problems like an <code>ArrayIndexOutOfBoundsException</code>.\n");
        buf.append(" *\n");
        buf.append(" * @see Test\n");
        buf.append(" */\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Adds an error to the list of errors. The passed in exception\n");
        buf.append("     * caused the error.\n");
        buf.append("     */\n");
        buf.append("    public synchronized void addError(final Test test, final Throwable t) {\n");
        buf.append("        this.fErrors.addElement(new TestFailure(test, t));\n");
        buf.append("        for (final Enumeration e= this.cloneListeners().elements(); e.hasMoreElements(); ) {\n");
        buf.append("            ((TestListener)e.nextElement()).addError(test, t);\n");
        buf.append("        }\n");
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Adds a failure to the list of failures. The passed in exception\n");
        buf.append("     * caused the failure.\n");
        buf.append("     */\n");
        buf.append("    public synchronized void addFailure(final Test test, final AssertionFailedError t) {\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A TestSuite for active Tests. It runs each\n");
        buf.append(" * test in a separate thread and waits until all\n");
        buf.append(" * threads have terminated.\n");
        buf.append(" * -- Aarhus Radisson Scandinavian Center 11th floor\n");
        buf.append(" */ \n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * An implementation of a TestCollector that considers\n");
        buf.append(" * a class to be a test class when it contains the\n");
        buf.append(" * pattern \"Test\" in its name\n");
        ...
        buf.append("        return \n");
        buf.append("            classFileName.endsWith(\".class\") &&  //$NON-NLS-1$\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * An implementation of a TestCollector that loads\n");
        buf.append(" * all classes on the class path and tests whether\n");
        buf.append(" * it is assignable from Test or provides a static suite method.\n");
        buf.append(" * @see TestCollector\n");
        buf.append(" */\n");
        ...
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    Class classFromFile(final String classFileName) throws ClassNotFoundException {\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A custom class loader which enables the reloading\n");
        buf.append(" * of classes for each test run. The class loader\n");
        buf.append(" * can be configured with a list of package paths that\n");
        buf.append(" * should be excluded from loading. The loading\n");
        buf.append(" * of these packages is delegated to the system class\n");
        buf.append(" * loader. They will be shared across test runs.\n");
        buf.append(" * <p>\n");
        buf.append(" * The list of excluded package paths is specified in\n");
        buf.append(" * a properties file \"excluded.properties\" that is located in \n");
        buf.append(" * the same place as the TestCaseClassLoader class.\n");
        buf.append(" * <p>\n");
        buf.append(" * <b>Known limitation:</b> the TestCaseClassLoader cannot load classes\n");
        buf.append(" * from jar files.\n");
        buf.append(" */\n");
        buf.append("\n");
        buf.append("\n");
        ...
        buf.append("    private final String[] defaultExclusions= {\n");
        buf.append("        \"junit.framework.\",  //$NON-NLS-1$\n");
        ...
        buf.append("     \n");
        buf.append("    /**\n");
        buf.append("     * Constructs a TestCaseLoader. It scans the class path\n");
        buf.append("     * and the excluded package paths\n");
        buf.append("     */\n");
        ...
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    private byte[] lookupClassData(final String className) throws ClassNotFoundException {\n");
        ...
        buf.append("        }\n");
        buf.append("            \n");
        buf.append("        final InputStream is= this.getClass().getResourceAsStream(TestCaseClassLoader.EXCLUDED_FILE);\n");
        buf.append("        if (is == null) {\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        ...
        buf.append("        suite.addTest(\n");
        buf.append("            new SimpleTest(\"add\") {\n");
        buf.append("                 protected void runTest() { testAdd(); }\n");
        buf.append("            }\n");
        buf.append("        );\n");
        buf.append("\n");
        buf.append("        suite.addTest(\n");
        buf.append("            new SimpleTest(\"testDivideByZero\") {\n");
        buf.append("                 protected void runTest() { testDivideByZero(); }\n");
        buf.append("            }\n");
        buf.append("        );\n");
        buf.append("        return suite;\n");
        buf.append("        */\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A helper test case for testing whether the testing method\n");
        buf.append(" * is run.\n");
        buf.append(" */\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A <code>TestSuite</code> is a <code>Composite</code> of Tests.\n");
        buf.append(" * It runs a collection of test cases. Here is an example using\n");
        buf.append(" * the dynamic test definition.\n");
        buf.append(" * <pre>\n");
        buf.append(" * TestSuite suite= new TestSuite();\n");
        buf.append(" * suite.addTest(new MathTest(\"testAdd\"));\n");
        buf.append(" * suite.addTest(new MathTest(\"testDivideByZero\"));\n");
        buf.append(" * </pre>\n");
        buf.append(" * Alternatively, a TestSuite can extract the tests to be run automatically.\n");
        buf.append(" * To do so you pass the class of your TestCase class to the\n");
        buf.append(" * TestSuite constructor.\n");
        buf.append(" * <pre>\n");
        buf.append(" * TestSuite suite= new TestSuite(MathTest.class);\n");
        buf.append(" * </pre>\n");
        buf.append(" * This constructor creates a suite with all the methods\n");
        buf.append(" * starting with \"test\" that take no arguments.\n");
        buf.append(" *\n");
        buf.append(" * @see Test\n");
        buf.append(" */\n");
        ...
        buf.append("     * starting with \"test\" as test cases to the suite.\n");
        buf.append("     * Parts of this method was written at 2337 meters in the Hüffihütte,\n");
        buf.append("     * Kanton Uri\n");
        buf.append("     */\n");
        buf.append("     public TestSuite(final Class theClass) {\n");
        buf.append("        this.fName= theClass.getName();\n");
        buf.append("        try {\n");
        buf.append("            TestSuite.getTestConstructor(theClass); // Avoid generating multiple error messages\n");
        buf.append("        } catch (final NoSuchMethodException e) {\n");
        buf.append("            this.addTest(TestSuite.warning(\"Class \"+theClass.getName()+\" has no public constructor TestCase(String name) or TestCase()\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        buf.append("\n");
        buf.append("        if (!Modifier.isPublic(theClass.getModifiers())) {\n");
        buf.append("            this.addTest(TestSuite.warning(\"Class \"+theClass.getName()+\" is not public\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        buf.append("\n");
        ...
        buf.append("            this.addTest(TestSuite.warning(\"No tests found in \"+theClass.getName())); //$NON-NLS-1$\n");
        buf.append("        }\n");
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("       /**\n");
        ...
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    private void addTestMethod(final Method m, final Vector names, final Class theClass) {\n");
        ...
        buf.append("                this.addTest(TestSuite.warning(\"Test method isn't public: \"+m.getName())); //$NON-NLS-1$\n");
        buf.append("            }\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * ...as the moon sets over the early morning Merlin, Oregon\n");
        buf.append("     * mountains, our intrepid adventurers type...\n");
        buf.append("     */\n");
        ...
        buf.append("        } catch (final NoSuchMethodException e) {\n");
        buf.append("            return TestSuite.warning(\"Class \"+theClass.getName()+\" has no public constructor TestCase(String name) or TestCase()\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        }\n");
        ...
        buf.append("            return(TestSuite.warning(\"Cannot instantiate test case: \"+name+\" (\"+TestSuite.exceptionToString(e)+\")\")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$\n");
        buf.append("        } catch (final InvocationTargetException e) {\n");
        buf.append("            return(TestSuite.warning(\"Exception in constructor: \"+name+\" (\"+TestSuite.exceptionToString(e.getTargetException())+\")\")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$\n");
        buf.append("        } catch (final IllegalAccessException e) {\n");
        buf.append("            return(TestSuite.warning(\"Cannot access test case: \"+name+\" (\"+TestSuite.exceptionToString(e)+\")\")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$\n");
        buf.append("        }\n");
        ...
        buf.append("    \n");
        buf.append("    /**\n");
        buf.append("     * Gets a constructor which takes a single String as\n");
        buf.append("     * its argument or a no arg constructor.\n");
        buf.append("     */\n");
        buf.append("    public static Constructor getTestConstructor(final Class theClass) throws NoSuchMethodException {\n");
        ...
        buf.append("        return (parameters.length == 0) && name.startsWith(\"test\") && returnType.equals(Void.TYPE); //$NON-NLS-1$\n");
        buf.append("     }\n");
        buf.append("     \n");
        buf.append("    /**\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Returns the name of the suite. Not all\n");
        buf.append("     * test suites have a name and this method\n");
        buf.append("     * can return null.\n");
        buf.append("     */\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A TestCase that expects an Exception of class fExpected to be thrown.\n");
        buf.append(" * The other way to check that an expected exception is thrown is:\n");
        buf.append(" * <pre>\n");
        buf.append(" * try {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Execute the test method expecting that an Exception of\n");
        buf.append("     * class fExpected or one of its subclasses will be thrown\n");
        buf.append("     */\n");
        buf.append("    @Override\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that a condition is true. If it isn't it throws\n");
        buf.append("     * an AssertionFailedError with the given message.\n");
        buf.append("     */\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two objects are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final Object expected, final Object actual) {\n");
        ...
        buf.append("    /**\n");
        buf.append("     * Asserts that two objects are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown.\n");
        buf.append("     */\n");
        ...
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final String expected, final String actual) {\n");
        buf.append("        if ((expected == null) && (actual == null)) {\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        buf.append("        if ((expected != null) && expected.equals(actual)) {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two doubles are equal concerning a delta.  If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.  If the expected\n");
        buf.append("     * value is infinity then the delta value is ignored.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final double expected, final double actual, final double delta) {\n");
        buf.append("        // handle infinity specially since subtracting to infinite values gives NaN and the\n");
        buf.append("        // the following test fails\n");
        buf.append("        if (Double.isInfinite(expected)) {\n");
        buf.append("            if (!(expected == actual)) {\n");
        buf.append("                Assert.failNotEquals(message, new Double(expected), new Double(actual));\n");
        buf.append("            }\n");
        ...
        buf.append("     * value is infinity then the delta value is ignored.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final double expected, final double actual, final double delta) {\n");
        buf.append("        Assert.assertEquals(null, expected, actual, delta);\n");
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two floats are equal concerning a delta. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.  If the expected\n");
        buf.append("     * value is infinity then the delta value is ignored.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final float expected, final float actual, final float delta) {\n");
        buf.append("         // handle infinity specially since subtracting to infinite values gives NaN and the\n");
        buf.append("        // the following test fails\n");
        buf.append("        if (Float.isInfinite(expected)) {\n");
        buf.append("            if (!(expected == actual)) {\n");
        buf.append("                Assert.failNotEquals(message, new Float(expected), new Float(actual));\n");
        buf.append("            }\n");
        buf.append("        } else if (!(Math.abs(expected-actual) <= delta)) {\n");
        buf.append("            Assert.failNotEquals(message, new Float(expected), new Float(actual));\n");
        buf.append("        }\n");
        ...
        buf.append("     * value is infinity then the delta value is ignored.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final float expected, final float actual, final float delta) {\n");
        buf.append("        Assert.assertEquals(null, expected, actual, delta);\n");
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two longs are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final long expected, final long actual) {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two booleans are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final boolean expected, final boolean actual) {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two bytes are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("      static public void assertEquals(final String message, final byte expected, final byte actual) {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two chars are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("      static public void assertEquals(final String message, final char expected, final char actual) {\n");
        buf.append("            Assert.assertEquals(message, new Character(expected), new Character(actual));\n");
        buf.append("      }\n");
        buf.append("    /**\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two shorts are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("    static public void assertEquals(final String message, final short expected, final short actual) {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two ints are equal. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("      static public void assertEquals(final String message, final int expected, final int actual) {\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that an object isn't null. If it is\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that an object is null.  If it is not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Asserts that two objects refer to the same object. If they are not\n");
        buf.append("     * an AssertionFailedError is thrown with the given message.\n");
        buf.append("     */\n");
        buf.append("    static public void assertSame(final String message, final Object expected, final Object actual) {\n");
        buf.append("        if (expected == actual) {\n");
        buf.append("            return;\n");
        buf.append("        }\n");
        ...
        buf.append("    /**\n");
        buf.append("     * Asserts that two objects refer to the same object. If they are not\n");
        buf.append("     * the same an AssertionFailedError is thrown.\n");
        buf.append("     */\n");
        ...
        buf.append("      * an AssertionFailedError is thrown with the given message.\n");
        buf.append("      */\n");
        buf.append("    static public void assertNotSame(final String message, final Object expected, final Object actual) {\n");
        buf.append("        if (expected == actual) {\n");
        ...
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    static private void failNotSame(final String message, final Object expected, final Object actual) {\n");
        buf.append("        String formatted= \"\"; //$NON-NLS-1$\n");
        buf.append("        if (message != null) {\n");
        buf.append("            formatted= message+\" \"; //$NON-NLS-1$\n");
        buf.append("        }\n");
        buf.append("        Assert.fail(formatted+\"expected same:<\"+expected+\"> was not:<\"+actual+\">\"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    static private void failNotEquals(final String message, final Object expected, final Object actual) {\n");
        buf.append("        Assert.fail(Assert.format(message, expected, actual));\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    static String format(final String message, final Object expected, final Object actual) {\n");
        buf.append("        String formatted= \"\"; //$NON-NLS-1$\n");
        buf.append("        if (message != null) {\n");
        buf.append("            formatted= message+\" \"; //$NON-NLS-1$\n");
        buf.append("        }\n");
        buf.append("        return formatted+\"expected:<\"+expected+\"> but was:<\"+actual+\">\"; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$\n");
        buf.append("    }\n");
        buf.append("}");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * An implementation of a TestCollector that consults the\n");
        buf.append(" * class path. It considers all classes on the class path\n");
        buf.append(" * excluding classes in JARs. It leaves it up to subclasses\n");
        buf.append(" * to decide whether a class is a runnable Test.\n");
        buf.append(" *\n");
        buf.append(" * @see TestCollector\n");
        buf.append(" */\n");
        ...
        buf.append("        final Hashtable result= this.collectFilesInRoots(this.splitClassPath(classPath));\n");
        ...
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    void gatherFiles(final File classRoot, final String classFileName, final Hashtable result) {\n");
        ...
        buf.append("                this.gatherFiles(classRoot, classFileName+File.separatorChar+element, result);\n");
        buf.append("            }        \n");
        buf.append("        }\n");
        buf.append("    }\n");
        buf.append("    \n");
        ...
        buf.append("        final String separator= System.getProperty(\"path.separator\"); //$NON-NLS-1$\n");
        buf.append("        final StringTokenizer tokenizer= new StringTokenizer(classPath, separator);\n");
        ...
        buf.append("        final String s= classFileName.substring(0, classFileName.length()-ClassPathTestCollector.SUFFIX_LENGTH);\n");
        ...
        buf.append(" * </pre>\n");
        buf.append(" * TestRunner expects the name of a TestCase class as argument.\n");
        buf.append(" * If this class defines a static <code>suite</code> method it \n");
        buf.append(" * will be invoked and the returned test is run. Otherwise all \n");
        buf.append(" * the methods starting with \"test\" having no arguments are run.\n");
        buf.append(" * <p>\n");
        buf.append(" * When the wait command line argument is given TestRunner\n");
        buf.append(" * waits until the users types RETURN.\n");
        buf.append(" * <p>\n");
        buf.append(" * TestRunner prints a trace as the tests are executed followed by a\n");
        buf.append(" * summary at the end. \n");
        buf.append(" */\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Runs a single test and collects its results.\n");
        buf.append("     * This method can be used to start a test run\n");
        buf.append("     * from your program.\n");
        buf.append("     * <pre>\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Runs a single test and waits until the user\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Always use the StandardTestSuiteLoader. Overridden from\n");
        buf.append("     * BaseTestRunner.\n");
        buf.append("     */\n");
        buf.append("    @Override\n");
        buf.append("    public TestSuiteLoader getLoader() {\n");
        buf.append("        return new StandardTestSuiteLoader();\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * Starts a test run. Analyzes the command line arguments\n");
        buf.append("     * and runs the given test suite.\n");
        buf.append("     */\n");
        ...
        buf.append("                System.err.println(\"JUnit \"+Version.id()+\" by Kent Beck and Erich Gamma\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("            } else {\n");
        ...
        buf.append("            throw new Exception(\"Usage: TestRunner [-wait] testCaseName, where name is the name of the TestCase class\"); //$NON-NLS-1$\n");
        buf.append("        }\n");
        buf.append("\n");
        buf.append("        try {\n");
        ...
        buf.append("        return ((cl != null) && cl.getClass().getName().equals(junit.runner.TestCaseClassLoader.class.getName()));\n");
        buf.append("    }\n");
        buf.append("    private void verifyApplicationClassLoadedByTestLoader() {\n");
        buf.append("        Assert.assertTrue(this.isTestCaseClassLoader(this.getClass().getClassLoader()));\n");
        buf.append("    } \n");
        buf.append("    private void verifySystemClassNotLoadedByTestLoader() {\n");
        buf.append("        Assert.assertTrue(!this.isTestCaseClassLoader(Object.class.getClassLoader()));\n");
        buf.append("        Assert.assertTrue(!this.isTestCaseClassLoader(TestCase.class.getClassLoader()));\n");
        buf.append("    }\n");
        buf.append("}");
        ...
        buf.append("        this.runner= new TestRunner(new TestResultPrinter(new PrintStream(this.output)));\n");
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    public void testEmptySuite() {\n");
        buf.append("        final String expected= this.expected(new String[]{\"\", \"Time: 0\", \"\", \"OK (0 tests)\", \"\"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$\n");
        ...
        buf.append("        final String expected= this.expected(new String[]{\".\", \"Time: 0\", \"\", \"OK (1 test)\", \"\"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$\n");
        buf.append("        final TestSuite suite = new TestSuite();\n");
        buf.append("        suite.addTest(new TestCase() { @Override\n");
        buf.append("        public void runTest() {}});\n");
        ...
        buf.append("        final String expected= this.expected(new String[]{\"..\", \"Time: 0\", \"\", \"OK (2 tests)\", \"\"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$\n");
        buf.append("        final TestSuite suite = new TestSuite();\n");
        buf.append("        suite.addTest(new TestCase() { @Override\n");
        buf.append("        public void runTest() {}});\n");
        buf.append("        suite.addTest(new TestCase() { @Override\n");
        ...
        buf.append("\n");
        buf.append("    public void testFailure() {\n");
        buf.append("        final String expected= this.expected(new String[]{\".F\", \"Time: 0\", \"Failures here\", \"\", \"FAILURES!!!\", \"Tests run: 1,  Failures: 1,  Errors: 0\", \"\"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$\n");
        buf.append("        final ResultPrinter printer= new TestResultPrinter(new PrintStream(this.output)) {\n");
        buf.append("            @Override\n");
        ...
        buf.append("        final TestSuite suite = new TestSuite();\n");
        buf.append("        suite.addTest(new TestCase() { @Override\n");
        buf.append("        public void runTest() {throw new AssertionFailedError();}});\n");
        buf.append("        this.runner.doRun(suite);\n");
        buf.append("        Assert.assertEquals(expected.toString(), this.output.toString());\n");
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    public void testError() {\n");
        buf.append("        final String expected= this.expected(new String[]{\".E\", \"Time: 0\", \"Errors here\", \"\", \"FAILURES!!!\", \"Tests run: 1,  Failures: 0,  Errors: 1\", \"\"}); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$\n");
        buf.append("        final ResultPrinter printer= new TestResultPrinter(new PrintStream(this.output)) {\n");
        buf.append("            @Override\n");
        ...
        buf.append("        final TestSuite suite = new TestSuite();\n");
        buf.append("        suite.addTest(new TestCase() { @Override\n");
        buf.append("        public void runTest() throws Exception {throw new Exception();}});\n");
        buf.append("        this.runner.doRun(suite);\n");
        buf.append("        Assert.assertEquals(expected.toString(), this.output.toString());\n");
        buf.append("    }\n");
        buf.append("    \n");
        ...
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"ba\", \"bc\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<...a> but was:<...c>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testComparisonErrorEndSame() {\n");
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"ab\", \"cb\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<a...> but was:<c...>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testComparisonErrorSame() {\n");
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"ab\", \"ab\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"abc\", \"adc\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<...b...> but was:<...d...>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testComparisonErrorStartSameComplete() {\n");
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"ab\", \"abc\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<...> but was:<...c>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testComparisonErrorEndSameComplete() {\n");
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"bc\", \"abc\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<...> but was:<a...>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testComparisonErrorOverlapingMatches() {\n");
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"abc\", \"abbc\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<......> but was:<...b...>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("    public void testComparisonErrorOverlapingMatches2() {\n");
        buf.append("        final ComparisonFailure failure= new ComparisonFailure(null, \"abcdde\", \"abcde\"); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("        Assert.assertEquals(\"expected:<...d...> but was:<......>\", failure.getMessage()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        ...
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    protected void printDefects(final Enumeration booBoos, final int count, final String type) {\n");
        ...
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    public void printDefect(final TestFailure booBoo, final int count) { // only public for testing purposes\n");
        ...
        buf.append("        // I feel like making this a println, then adding a line giving the throwable a chance to print something\n");
        ...
        buf.append("            this.getWriter().println (\" (\" + result.runCount() + \" test\" + (result.runCount() == 1 ? \"\": \"s\") + \")\"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$\n");
        buf.append("\n");
        buf.append("        } else {\n");
        buf.append("            this.getWriter().println();\n");
        ...
        buf.append("    /**\n");
        buf.append("     * Returns the formatted string of the elapsed time.\n");
        buf.append("     * Duplicated from BaseTestRunner. Fix it.\n");
        buf.append("     */\n");
        buf.append("    protected String elapsedTimeAsString(final long runTime) {\n");
        buf.append("        return NumberFormat.getInstance().format((double)runTime/1000);\n");
        buf.append("    }\n");
        ...
        buf.append("     */\n");
        buf.append("    public ComparisonFailure (final String message, final String expected, final String actual) {\n");
        buf.append("        super (message);\n");
        ...
        buf.append("    \n");
        buf.append("    /**\n");
        buf.append("     * Returns \"...\" in place of common prefix and \"...\" in\n");
        buf.append("     * place of common suffix between expected and actual.\n");
        buf.append("     * \n");
        ...
        buf.append("            return Assert.format(super.getMessage(), this.fExpected, this.fActual);\n");
        buf.append("        }\n");
        buf.append("            \n");
        buf.append("        final int end= Math.min(this.fExpected.length(), this.fActual.length());\n");
        buf.append("        \n");
        buf.append("        int i= 0;\n");
        ...
        buf.append("        Assert.assertEquals(\"testCaseToString(junit.tests.framework.TestCaseTest)\", this.toString()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("    public void testError() {\n");
        buf.append("        final TestCase error= new TestCase(\"error\") { //$NON-NLS-1$\n");
        buf.append("            @Override\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A <code>TestFailure</code> collects a failed test together with\n");
        buf.append(" * the caught exception.\n");
        ...
        buf.append("        buffer.append(this.fFailedTest+\": \"+this.fThrownException.getMessage()); //$NON-NLS-1$\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A Decorator to set up and tear down additional fixture state.\n");
        buf.append(" * Subclass TestSetup and insert it into your tests when you want\n");
        buf.append(" * to set up additional state once before the tests are run.\n");
        buf.append(" */\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Sets up the fixture. Override to set up additional fixture\n");
        buf.append("     * state.\n");
        buf.append("     */\n");
        buf.append("    protected void setUp() throws Exception {\n");
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Tears down the fixture. Override to tear down the additional\n");
        buf.append("     * fixture state.\n");
        buf.append("     */\n");
        ...
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    void execTest(final String testClass, final boolean success) throws Exception {\n");
        ...
        buf.append("        final String [] cmd= { java, \"-classpath\", cp, \"junit.textui.TestRunner\", testClass};  //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("            Assert.assertEquals(junit.textui.TestRunner.SUCCESS_EXIT, p.exitValue());\n");
        buf.append("        } else {\n");
        buf.append("            Assert.assertEquals(junit.textui.TestRunner.FAILURE_EXIT, p.exitValue());\n");
        buf.append("        }\n");
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    public void testRunReturnsResult() {\n");
        buf.append("        final PrintStream oldOut= System.out;\n");
        buf.append("        System.setOut(new PrintStream (\n");
        buf.append("            new OutputStream() {\n");
        buf.append("                @Override\n");
        ...
        buf.append("        ));\n");
        buf.append("        try {\n");
        buf.append("            final TestResult result= junit.textui.TestRunner.run(new TestSuite());\n");
        buf.append("            Assert.assertTrue(result.wasSuccessful());\n");
        buf.append("        } finally {\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A custom quick sort with support to customize the swap behaviour.\n");
        buf.append(" * NOTICE: We can't use the the sorting support from the JDK 1.2 collection\n");
        buf.append(" * classes because of the JDK 1.1.7 compatibility.\n");
        buf.append(" */\n");
        ...
        buf.append("    }\n");
        buf.append("        \n");
        buf.append("    public static void sortStrings(final Vector values , int left, int right, final Swapper swapper) { \n");
        ...
        buf.append("        suite.addTest(SuiteTest.suite()); // Tests suite building, so can't use automatic test extraction \n");
        ...
        buf.append("    }\n");
        buf.append("    \n");
        buf.append("    public static Test suite() { // Collect tests manually because we have to test class collection code\n");
        buf.append("        final TestSuite suite= new TestSuite(\"Framework Tests\"); //$NON-NLS-1$\n");
        ...
        buf.append("\n");
        buf.append("/**\n");
        buf.append(" * A MoneyBag defers exchange rate conversions. For example adding \n");
        buf.append(" * 12 Swiss Francs to 14 US Dollars is represented as a bag \n");
        buf.append(" * containing the two Monies 12 CHF and 14 USD. Adding another\n");
        buf.append(" * 10 Swiss francs gives a bag with 22 CHF and 14 USD. Due to \n");
        buf.append(" * the deferred exchange rate conversion we can later value a \n");
        buf.append(" * MoneyBag with different exchange rates.\n");
        buf.append(" *\n");
        buf.append(" * A MoneyBag is represented as a list of Monies and provides \n");
        buf.append(" * different constructors to create a MoneyBag. \n");
        buf.append(" */ \n");
        ...
        buf.append("        Assert.assertFalse(collector.collectFilesInPath(\"foobar\").elements().hasMoreElements()); //$NON-NLS-1$\n");
        buf.append("    }\n");
        buf.append("\n");
        buf.append("}\n");
        buf.append("\n");
        ...
        buf.append(" * Each test runs in its own fixture so there\n");
        buf.append(" * can be no side effects among test runs.\n");
        buf.append(" * Here is an example:\n");
        buf.append(" * <pre>\n");
        ...
        buf.append(" * </pre>\n");
        buf.append(" *\n");
        buf.append(" * For each test implement a method which interacts\n");
        buf.append(" * with the fixture. Verify the expected results with assertions specified\n");
        buf.append(" * by calling <code>assertTrue</code> with a boolean.\n");
        buf.append(" * <pre>\n");
        buf.append(" *    public void testAdd() {\n");
        ...
        buf.append(" *    }\n");
        buf.append(" * </pre>\n");
        buf.append(" * Once the methods are defined you can run them. The framework supports\n");
        buf.append(" * both a static type safe and more dynamic way to run a test.\n");
        buf.append(" * In the static way you override the runTest method and define the method to\n");
        buf.append(" * be invoked. A convenient way to do so is with an anonymous inner class.\n");
        buf.append(" * <pre>\n");
        ...
        buf.append(" * test.run();\n");
        buf.append(" * </pre>\n");
        buf.append(" * The dynamic way uses reflection to implement <code>runTest</code>. It dynamically finds\n");
        buf.append(" * and invokes a method.\n");
        buf.append(" * In this case the name of the test case has to correspond to the test method\n");
        buf.append(" * to be run.\n");
        buf.append(" * <pre>\n");
        buf.append(" * TestCase= new MathTest(\"testAdd\");\n");
        buf.append(" * test.run();\n");
        buf.append(" * </pre>\n");
        buf.append(" * The tests to be run can be collected into a TestSuite. JUnit provides\n");
        buf.append(" * different <i>test runners</i> which can run a test suite and collect the results.\n");
        buf.append(" * A test runner either expects a static method <code>suite</code> as the entry\n");
        buf.append(" * point to get a test to run or it will extract the suite automatically.\n");
        buf.append(" * <pre>\n");
        buf.append(" * public static Test suite() {\n");
        buf.append(" *      suite.addTest(new MathTest(\"testAdd\"));\n");
        buf.append(" *      suite.addTest(new MathTest(\"testDivideByZero\"));\n");
        ...
        buf.append("\n");
        buf.append("    /**\n");
        buf.append("     * No-arg constructor to enable serialization. This method\n");
        buf.append("     * is not intended to be used by mere mortals without calling setName().\n");
        buf.append("     */\n");
        ...
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Sets up the fixture, for example, open a network connection.\n");
        buf.append("     * This method is called before a test is executed.\n");
        buf.append("     */\n");
        buf.append("    protected void setUp() throws Exception {\n");
        buf.append("    }\n");
        buf.append("    /**\n");
        buf.append("     * Tears down the fixture, for example, close a network connection.\n");
        buf.append("     * This method is called after a test is executed.\n");
        buf.append("     */\n");
        buf.append("    protected void tearDown() throws Exception {\n");
        buf.append("    }\n");
        buf.append("    /**\n");
        ...
        buf.append("        final IMoney expected= MoneyBag.create(new Money(24, \"CHF\"), new Money(14, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final IMoney expected= MoneyBag.create(new Money(-12, \"CHF\"), new Money(-7, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final IMoney expected= MoneyBag.create(new Money(26, \"CHF\"), new Money(7, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final IMoney expected= MoneyBag.create(new Money(-2, \"CHF\"), new Money(-14, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final IMoney expected= MoneyBag.create(new Money(26, \"CHF\"), new Money(28, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        Assert.assertTrue(MoneyBag.create(new Money (0, \"CHF\"), new Money (0, \"USD\")).isZero()); //$NON-NLS-1$ //$NON-NLS-2$\n");
        buf.append("    }\n");
        ...
        buf.append("        final IMoney equal= MoneyBag.create(new Money(12, \"CHF\"), new Money(7, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final IMoney money= MoneyBag.create(new Money(26, \"CHF\"), new Money(28, \"CHF\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final IMoney ms1= MoneyBag.create(new Money(12, \"CHF\"), new Money(3, \"USD\")); //$NON-NLS-1$ //$NON-NLS-2$\n");
        ...
        buf.append("        final Class loadedClass= loader.loadClass(\"junit.tests.runner.ClassLoaderTest\", true); //$NON-NLS-1$\n");
        ...
        buf.append("        //\n");
        buf.append("        final Method method= loadedClass.getDeclaredMethod(\"verify\", new Class[0]); //$NON-NLS-1$\n");
        ...
        buf.append("        final Class loadedClass= loader.loadClass(\"junit.tests.runner.LoadedFromJar\", true); //$NON-NLS-1$\n");
        buf.append("        final Object o= loadedClass.newInstance();\n");
        buf.append("        //\n");
        buf.append("        // Invoke the assertClassLoaders method via reflection.\n");
        buf.append("        // We use reflection since the class is loaded by\n");
