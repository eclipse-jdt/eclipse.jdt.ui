...
public class Java21ProjectTestSetup extends ProjectTestSetup {

	public static final String PROJECT_NAME21= "TestSetupProject21";
	...
	public IClasspathEntry[] getDefaultClasspath() throws CoreException {
		IPath[] rtJarPath= JavaProjectHelper.findRtJar(JavaProjectHelper.RT_STUBS21);
	...
	public Java21ProjectTestSetup() {
		projectName= PROJECT_NAME21;
	}

	public Java21ProjectTestSetup( String projectName) {
	...
	protected IJavaProject createAndInitializeProject() throws CoreException {
		...
		JavaProjectHelper.set21CompilerOptions(javaProject);
		return javaProject;
	}
