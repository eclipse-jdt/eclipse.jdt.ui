...
public class Java25ProjectTestSetup extends ProjectTestSetup {

	public static final String PROJECT_NAME25= "TestSetupProject25";
	...
	public IClasspathEntry[] getDefaultClasspath() throws CoreException {
		IPath[] rtJarPath= JavaProjectHelper.findRtJar(JavaProjectHelper.RT_STUBS25);
	...
	protected IJavaProject createAndInitializeProject() throws CoreException {
		...
		JavaProjectHelper.set25CompilerOptions(javaProject, enable_preview_feature);
		return javaProject;
	}
