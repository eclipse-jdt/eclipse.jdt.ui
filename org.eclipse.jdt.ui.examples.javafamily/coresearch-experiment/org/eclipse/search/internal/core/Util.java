...
public class Util {
	...
	private final static String bundleName = "org.eclipse.search.internal.core.messages"; //$NON-NLS-1$
	...
	/**
	 * Constant for an empty char array (borrowed from CharOperation (jdt.core)
	 */
	...
	/**
	 * BORROWED FROM CharOperation (jdt.core)
	...
	public static void log(Throwable e, String message) {
		IStatus status= new Status(
			IStatus.ERROR, 
			SearchCore.getPlugin().getDescriptor().getUniqueIdentifier(), 
			IStatus.ERROR, 
			message, 
			e); 
		SearchCore.getPlugin().getLog().log(status);
	}	
	...
	/**
	 * BORROWED FROM JDT/Core: CharOperation.
