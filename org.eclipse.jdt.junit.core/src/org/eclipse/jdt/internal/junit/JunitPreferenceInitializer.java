...
public class JunitPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		prefs.put(JUnitPreferencesConstants.JUNIT6_JUPITER_API_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_JUPITER_ENGINE_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_JUPITER_MIGRATIONSUPPORT_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_JUPITER_PARAMS_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_COMMONS_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_ENGINE_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_LAUNCHER_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_RUNNER_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_SUITE_API_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_SUITE_ENGINE_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_PLATFORM_SUITE_COMMONS_JAVADOC, junit6JavadocLocation);
		prefs.put(JUnitPreferencesConstants.JUNIT6_VINTAGE_ENGINE_JAVADOC, junit6JavadocLocation);
	}
}
