...
public class BuildPathSupport {
	...
	public static final JUnitPluginDescription JUNIT6_JUPITER_MIGRATIONSUPPORT_PLUGIN= new JUnitPluginDescription(
			"junit-jupiter-migrationsupport", new VersionRange("[6.0.0,7.0.0)"), null, "junit-jupiter-migrationsupport_6.*.jar", "junit-jupiter-migrationsupport.source", "", //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$//$NON-NLS-5$
			JUnitPreferencesConstants.JUNIT_JUPITER_MIGRATIONSUPPORT_JAVADOC);
	...
	public static final JUnitPluginDescription JUNIT6_VINTAGE_ENGINE_PLUGIN= new JUnitPluginDescription(
			"junit-vintage-engine", new VersionRange("[6.0.0,7.0.0)"), null, "junit-vintage-engine_6.*.jar", "org.junit.vintage.engine.source", "", //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$//$NON-NLS-5$
			JUnitPreferencesConstants.JUNIT_VINTAGE_ENGINE_JAVADOC);
	...
	/**
	 * @return the org.junit.jupiter.migrationsupport JUnit 6 library, or <code>null</code> if not available
	 */
	public static IClasspathEntry getJUnit6JupiterMigrationSupportLibraryEntry() {
		return JUNIT6_JUPITER_MIGRATIONSUPPORT_PLUGIN.getLibraryEntry();
	}
	...
	/**
	 * @return the org.junit.vintage.engine JUnit 6 library, or <code>null</code> if not available
	 */
	public static IClasspathEntry getJUnit6VintageEngineLibraryEntry() {
		return JUNIT6_VINTAGE_ENGINE_PLUGIN.getLibraryEntry();
	}
