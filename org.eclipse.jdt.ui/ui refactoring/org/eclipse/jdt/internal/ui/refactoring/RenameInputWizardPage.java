...
public class RenameInputWizardPage extends TextInputWizardPage{
	...
		public void setVisible(boolean visible){		if (visible)			setDescription("Specify a new name for the selected element.");		super.setVisible(visible);		}	
	/* non java-doc
