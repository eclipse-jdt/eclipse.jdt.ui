...
/**
 * Action to export the workspace refactoring history.
 * 
 * @since 3.2
 */
public class ExportWorkspaceHistoryActionDelegate implements IWorkbenchWindowActionDelegate {

	/** The bundle name */
	private static final String BUNDLE_NAME= "org.eclipse.jdt.internal.ui.refactoring.actions.ExportRefactoringHistoryDialog"; //$NON-NLS-1$

	/** The workbench window */
	private IWorkbenchWindow fWindow= null;

	/**
	 * Creates a new export workspace history action delegate.
	 */
	public ExportWorkspaceHistoryActionDelegate() {
		// Do nothing
	}
