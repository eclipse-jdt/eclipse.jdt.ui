...
public class RenameLinkedMode {
	...
	public void start() {
		...
		try {
			CompilationUnit root= SharedASTProviderCore.getAST(getCompilationUnit(), SharedASTProviderCore.WAIT_YES, null);
	...
	private RenameJavaElementDescriptor createRenameDescriptor(IJavaElement javaElement, String newName) throws JavaModelException {
		...
		switch (elementType) {
			...
			case IJavaElement.JAVA_MODULE:
				contributionId= IJavaRefactorings.RENAME_MODULE;
				break;
			default:
				return null;
		}
...
//			case IJavaElement.COMPILATION_UNIT: // TODO
	...
	public LinkedPosition getCurrentLinkedPosition() {
		ISourceViewer viewer= fEditor.getViewer();
		if (viewer == null) {
			return null; // happens on eclipse restart
		}
