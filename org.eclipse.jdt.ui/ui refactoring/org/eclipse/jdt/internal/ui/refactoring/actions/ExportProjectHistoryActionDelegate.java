 ...
 * @since 3.2
 */
public final class ExportProjectHistoryActionDelegate extends ExportWorkspaceHistoryActionDelegate {

	/** The selected project */
	private IProject fProject= null;

	/**
	 * Creates a new export project history action delegate.
	 */
	public ExportProjectHistoryActionDelegate() {
		// Do nothing
	}
