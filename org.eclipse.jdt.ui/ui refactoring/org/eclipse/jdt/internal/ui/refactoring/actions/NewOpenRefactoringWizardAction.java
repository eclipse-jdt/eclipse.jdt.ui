...
public abstract class NewOpenRefactoringWizardAction extends SelectionDispatchAction {

	private Class fActivationType;
	private Refactoring fRefactoring;
	
	protected NewOpenRefactoringWizardAction(String label, UnifiedSite site, Class activatedOnType) {
		super(site);
		setText(label);
