...
public class CreateLinkedSourceFolderAction extends Action implements ISelectionChangedListener {
    ...
    private AddSourceFolderWizard createWizard() throws CoreException {
    	...
    	return new AddSourceFolderWizard(existing, newEntrie, getOutputLocation(fSelectedProject), true, false, false, isProjectSrcFolder, isProjectSrcFolder);
    }
