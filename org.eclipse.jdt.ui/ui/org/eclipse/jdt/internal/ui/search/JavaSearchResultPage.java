...
public class JavaSearchResultPage extends AbstractTextSearchViewPage implements IAdaptable {
	...
	private void initGroupingActions() {
		...
		JavaPluginImages.setLocalImageDescriptors(fGroupProjectAction, "prj_mode.svg"); //$NON-NLS-1$
		...
		JavaPluginImages.setLocalImageDescriptors(fGroupPackageAction, "package_mode.svg"); //$NON-NLS-1$
		...
		JavaPluginImages.setLocalImageDescriptors(fGroupFileAction, "file_mode.svg"); //$NON-NLS-1$
		...
		JavaPluginImages.setLocalImageDescriptors(fGroupTypeAction, "type_mode.svg"); //$NON-NLS-1$
	}
