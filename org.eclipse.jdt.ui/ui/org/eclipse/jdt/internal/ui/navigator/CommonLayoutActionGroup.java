...
public class CommonLayoutActionGroup extends MultiActionGroup {
	...
	private IAction[] createActions() {
		...
		JavaPluginImages.setLocalImageDescriptors(fFlatLayoutAction, "flatLayout.svg"); //$NON-NLS-1$
		...
		JavaPluginImages.setLocalImageDescriptors(fHierarchicalLayout, "hierarchicalLayout.svg"); //$NON-NLS-1$
