...
public class HashCodeEqualsTypeProposal extends ChangeCorrectionProposal { // public for tests

	private IType fType;

	public HashCodeEqualsTypeProposal(int relevance, IType type) {
	...
	private static String getDescription(IType type) {
		return Messages.format(CorrectionMessages.AddHashCodeEquals_createhashcodeequalsfortype_description, BasicElementLabels.getJavaElementName(type.getElementName()));
	}
	...
	public Object getAdditionalProposalInfo(IProgressMonitor monitor) {
		return CorrectionMessages.AddHashCodeEquals_additional_info;
	}
