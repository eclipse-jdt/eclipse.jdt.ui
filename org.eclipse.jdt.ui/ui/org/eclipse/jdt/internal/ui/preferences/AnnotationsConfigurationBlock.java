...
public class AnnotationsConfigurationBlock {
	...
	private final String[][] fAnnotationDecorationListModel= new String[][] {
			{PreferencesMessages.getString("AnnotationConfigurationBlock.NONE"), AnnotationPreference.STYLE_NONE}, //$NON-NLS-1$
			{PreferencesMessages.getString("AnnotationConfigurationBlock.SQUIGGLES"), AnnotationPreference.STYLE_SQUIGGLES}, //$NON-NLS-1$
			{PreferencesMessages.getString("AnnotationConfigurationBlock.UNDERLINE"), AnnotationPreference.STYLE_UNDERLINE}, //$NON-NLS-1$
			{PreferencesMessages.getString("AnnotationConfigurationBlock.BOX"), AnnotationPreference.STYLE_BOX}, //$NON-NLS-1$
			{PreferencesMessages.getString("AnnotationConfigurationBlock.IBEAM"), AnnotationPreference.STYLE_IBEAM} //$NON-NLS-1$
		};
	...
	Control createContents(Composite parent) {
		...
		label.setText(PreferencesMessages.getString("AnnotationConfigurationBlock.annotationPresentationOptions")); //$NON-NLS-1$
        ...
        fShowInTextCheckBox.setText(PreferencesMessages.getString("AnnotationConfigurationBlock.showInText")); //$NON-NLS-1$
		...
		fHighlightInTextCheckBox.setText(PreferencesMessages.getString("AnnotationConfigurationBlock.highlightInText")); //$NON-NLS-1$
		gd= new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalAlignment= GridData.BEGINNING;
		gd.horizontalSpan= 2;
        ...
        fShowInOverviewRulerCheckBox.setText(PreferencesMessages.getString("AnnotationConfigurationBlock.showInOverviewRuler")); //$NON-NLS-1$
		gd= new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalAlignment= GridData.BEGINNING;
        gd.horizontalSpan= 2;
		...
		fShowInVerticalRulerCheckBox.setText(PreferencesMessages.getString("AnnotationConfigurationBlock.showInVerticalRuler")); //$NON-NLS-1$
		gd= new GridData(GridData.FILL_HORIZONTAL);
		gd.horizontalAlignment= GridData.BEGINNING;
		gd.horizontalSpan= 2;
		...
		label.setText(PreferencesMessages.getString("AnnotationConfigurationBlock.color")); //$NON-NLS-1$
		gd= new GridData();
		gd.horizontalAlignment= GridData.BEGINNING;
		label.setLayoutData(gd);
