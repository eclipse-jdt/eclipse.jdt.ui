...
public class WorkingSetPropertyPage extends WizardPropertyPage {
	...
	private static final class ReadOnlyPage extends WizardPage {
		...
		protected ReadOnlyPage() {
			super(PreferencesMessages.WorkingSetPropertyPage_ReadOnlyWizard_title);
			setDescription(PreferencesMessages.WorkingSetPropertyPage_ReadOnlyWizard_description);
		}
