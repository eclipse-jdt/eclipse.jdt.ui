...
public class FormatterModifyDialog extends ModifyDialog {
	...
	private void createLineWrapTree() {
		...
		fTree.builder(FormatterMessages.FormatterModifyDialog_lineWrap_tree_wrapping_settings, null, modAll)
				.node(fTree.builder(FormatterMessages.FormatterModifyDialog_lineWrap_tree_class_decls, null, modAll)
						...
						.pref(FormatterMessages.FormatterModifyDialog_lineWrap_pref_permits_clause, DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_PERMITTED_TYPES_IN_TYPE_DECLARATION))
	...
	private void createCommentsTree() {
		Section section= fTree.builder(FormatterMessages.FormatterModifyDialog_comments_tree_comments, "section-comments") //$NON-NLS-1$
				...
				.gap()
				.pref(FormatterMessages.FormatterModifyDialog_comments_pref_enable_markdown, DefaultCodeFormatterConstants.FORMATTER_COMMENT_FORMAT_MARKDOWN_COMMENT, pref -> {
					CheckboxPreference child= fTree.addCheckbox(pref, FormatterMessages.FormatterModifyDialog_comments_pref_format_markdown_tags,
							DefaultCodeFormatterConstants.FORMATTER_COMMENT_FORMAT_MARKDOWN_TAGS, CheckboxPreference.FALSE_TRUE);
