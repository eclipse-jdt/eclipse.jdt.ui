...
public final class JavaFeatureTabPage extends AbstractCleanUpTabPage {
	...
	protected void doCreatePreferences(final Composite composite, final int numColumns) {
		...
		CheckboxPreference systemconstantsIntegerProperty= createCheckboxPref(java1d7Group, 1, CleanUpMessages.JavaFeatureTabPage_CheckboxName_ConstantsForSystemProperty_IntegerProperty, CleanUpConstants.CONSTANTS_FOR_SYSTEM_PROPERTY_INTEGER, CleanUpModifyDialog.FALSE_TRUE);
		CheckboxPreference systemconstantsLongProperty= createCheckboxPref(java1d7Group, 1, CleanUpMessages.JavaFeatureTabPage_CheckboxName_ConstantsForSystemProperty_LongProperty, CleanUpConstants.CONSTANTS_FOR_SYSTEM_PROPERTY_LONG, CleanUpModifyDialog.FALSE_TRUE);
		registerSlavePreference(systemconstants, new CheckboxPreference[] {systemconstantsFileSeparator,systemconstantsPathSeparator,systemconstantsLineSeparator,systemconstantsFileEncoding,systemconstantsBooleanProperty,systemconstantsIntegerProperty,systemconstantsLongProperty});
