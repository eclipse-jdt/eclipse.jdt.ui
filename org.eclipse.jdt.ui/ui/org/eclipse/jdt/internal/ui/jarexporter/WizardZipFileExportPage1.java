...
class WizardZipFileExportPage1 extends WizardFileSystemExportPage1 {
	...
	public boolean finish() {
		...
		if (resourcesToExport.size() > 0)
			return executeExportOperation(new ZipFileExportOperation(getSourceResource(), resourcesToExport, getDestinationValue()));

		MessageDialog.openInformation(getContainer().getShell(), "Information", "There are no resources currently selected for export.");
