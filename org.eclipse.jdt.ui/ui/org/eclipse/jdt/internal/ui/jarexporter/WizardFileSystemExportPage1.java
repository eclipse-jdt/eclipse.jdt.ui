 ...
 */
/*package*/
class WizardFileSystemExportPage1 extends WizardExportPage implements Listener {
	...
	protected void createOptionsGroup(Composite parent) {
		...
		createDirectoriesForSelectedContainersCheckbox.setText("Create directories for selected containers");
	...
	protected void internalSaveWidgetValues() {
		...
		if (settings != null) {
			...
			settings.put(STORE_CREATE_DIRECTORIES_FOR_SPECIFIED_CONTAINER_ID, createDirectoriesForSelectedContainersCheckbox.getSelection());
	...
	protected void restoreWidgetValues() {
		...
		if (settings != null) {
			...
			createDirectoriesForSelectedContainersCheckbox.setSelection(settings.getBoolean(STORE_CREATE_DIRECTORIES_FOR_SPECIFIED_CONTAINER_ID));
		}
	}
