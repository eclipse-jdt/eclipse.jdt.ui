...
public class JavaElementOpenInNewImplementationHyperlink implements IHyperlink {
	...
	/**
	 * Opens the given implementation hyperlink for types and methods in a new cloned editor.
	 */
	@Override
	public void open() {
		openInNewEditor(javaElement);
	}

	/**
	 * Opens the method or type in a new cloned editor
	 *
	 * @param javaElement the method or type
	 */
	public static void openInNewEditor(final IJavaElement javaElement) {
		try {
