			...
			runnable= monitor -> {
				...
				try {
					...
					if (receiverType.isInterface()) {
						...
						if (isFullHierarchyNeeded(SubMonitor.convert(monitor, 3), method, receiverType))
					...
					engine.search(pattern, participants, hierarchyScope, requestor, SubMonitor.convert(monitor, 7));
