...
public class RunToLineAction extends ResourceAction implements IUpdate {
	 ...
	 */
	protected JDIDebugTarget getContext() {
	 ...
	 */
	protected JDIDebugTarget getContextFromModel() {
	 ...
	 * Resolves a debug target context from the model
	 */
	protected JDIDebugTarget getContextFromThread(IThread thread) {
	 ...
	 */
	protected JDIDebugTarget getContextFromUI() {
	 ...
	 */
	protected JDIDebugTarget getContextFromDebugTarget(JDIDebugTarget dt) {
		if (!dt.isTerminated()) {
