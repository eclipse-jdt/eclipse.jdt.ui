...
class LayoutAction extends Action {
	...
	public LayoutAction(PackageExplorerPart packageExplorer, boolean flat) {
		...
		if (fIsFlatLayout) {
			...
			JavaPluginImages.setLocalImageDescriptors(this, "flatLayout.svg"); //$NON-NLS-1$
			...
			JavaPluginImages.setLocalImageDescriptors(this, "hierarchicalLayout.svg"); //$NON-NLS-1$
