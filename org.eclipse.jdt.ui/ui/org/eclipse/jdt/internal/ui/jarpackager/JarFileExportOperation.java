...
public class JarFileExportOperation implements IRunnableWithProgress {
	...
	private Map buildJavaToClassMap(IFolder folder) throws CoreException {
		...
		/*		 * XXX Should not use internal class rom JCore		 */
