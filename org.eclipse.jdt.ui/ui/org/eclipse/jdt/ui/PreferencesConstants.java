...
public class PreferencesConstants {
	 ...
	 */
	public static final String LINK_TYPEHIERARCHY_TO_EDITOR= JavaBasePreferencePage.SHOW_CU_CHILDREN;
	 ...
	 */
	public final static String EDITOR_LINENUMBER_RULER= JavaEditor.LINE_NUMBER_RULER;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
	public final static String EDITOR_LINENUMBER_RULER_COLOR= JavaEditor.LINE_NUMBER_COLOR;
	...
	/**
	 * Color used for default text. RGB color encoded using PreferenceConverter.
	 * @see org.eclipse.jface.resource.StringConverter
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
	...
	/**
	 * Enable / Disable the usage of bold style for default text.
	 */
	...
	/**
	 * Enable / Disable the autoactivation behaviour of the Java code assist. Boolean value.
	 */
	public final static String CODEASSIST_AUTOACTIVATION= ContentAssistPreference.AUTOACTIVATION;

	/**
	 * Specifies the auto activation delay. Int value.
	 */
	...
	/**
	 * Enable / Disable case sensitivity in code assist. Boolean value.
	 */
