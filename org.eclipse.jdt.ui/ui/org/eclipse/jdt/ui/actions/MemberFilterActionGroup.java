...
public class MemberFilterActionGroup extends ActionGroup {
	...
	public MemberFilterActionGroup(StructuredViewer viewer, String viewerId) {
		...
		MemberFilterAction hideFields= new MemberFilterAction(this, title, FILTER_FIELDS, helpContext, doHideFields, false);
		...
		MemberFilterAction hideStatic= new MemberFilterAction(this, title, FILTER_STATIC, helpContext, doHideStatic, false);
		...
		MemberFilterAction hideNonPublic= new MemberFilterAction(this, title, FILTER_NONPUBLIC, helpContext, doHidePublic, true);
	...
	public void setMemberFilter(int filterProperty, boolean set) {
		...
		for (int i= 0; i < fFilterActions.length; i++) {
			...
			if (currProperty == filterProperty) {
				fFilterActions[i].setFilter(set);
			}
