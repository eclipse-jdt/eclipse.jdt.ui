...
public final class EqualsOperator extends ConstraintOperator{
	
	public static final String OPERATOR_STRING= "==";

	private static final EqualsOperator fgInstance= new EqualsOperator(); 
