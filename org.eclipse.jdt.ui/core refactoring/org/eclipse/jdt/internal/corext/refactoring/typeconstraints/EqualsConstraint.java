...
public class EqualsConstraint extends SimpleTypeConstraint implements ITypeConstraint {

	public EqualsConstraint(ConstraintVariable left, ConstraintVariable right){
		super(left, right);
	}
