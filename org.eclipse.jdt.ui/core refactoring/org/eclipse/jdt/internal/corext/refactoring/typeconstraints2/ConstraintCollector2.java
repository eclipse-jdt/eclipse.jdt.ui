...
public final class ConstraintCollector2 extends ASTVisitor {

	private final ConstraintCreator2 fCreator;
	private final Set fCollectedConstraints;
	
	public ConstraintCollector2(ConstraintCreator2 creator) {
		Assert.isNotNull(creator);
		fCreator= creator;
		fCollectedConstraints= new HashSet();
	}

	private void add(ITypeConstraint2[] constraints){
		fCollectedConstraints.addAll(Arrays.asList(constraints));
	}
	
	public void clear(){
		fCollectedConstraints.clear();
	}

	public ITypeConstraint2[] getConstraints(){
		return (ITypeConstraint2[]) fCollectedConstraints.toArray(new ITypeConstraint2[fCollectedConstraints.size()]);
	}
