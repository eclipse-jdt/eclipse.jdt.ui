...
public class DefinesConstraint extends SimpleTypeConstraint implements ITypeConstraint {
	
	public DefinesConstraint(ConstraintVariable left, ConstraintVariable right){
		super(left, right);
	}
