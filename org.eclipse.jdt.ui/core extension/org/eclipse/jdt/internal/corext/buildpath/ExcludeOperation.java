 ...
 * 
 * @see org.eclipse.jdt.internal.corext.buildpath.ClasspathModifier#exclude(IJavaElement, IJavaProject, IProgressMonitor)
...
public class ExcludeOperation extends ClasspathModifierOperation {
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException {
        ...
        try {
            ...
            result= exclude(javaElement, project, monitor);
