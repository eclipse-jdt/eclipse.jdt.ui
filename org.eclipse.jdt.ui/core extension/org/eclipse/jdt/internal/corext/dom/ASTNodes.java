	...
	public static Expression getAssignedValue(ASTNode node, ASTRewrite astRewrite, Expression getterExpression, ITypeBinding variableType, boolean is50OrHigher) {
		...
		if (node.getNodeType() == ASTNode.ASSIGNMENT) { 
			...
			if (assignment.getOperator() == Operator.ASSIGN) {
				...
				copiedRightOp= ASTNodes.createNarrowCastIfNessecary(copiedRightOp, rightHandSideType, ast, variableType, is50OrHigher);
			...
			if (getterExpression != null) { 
				...
				return ASTNodes.createNarrowCastIfNessecary(infix, infixType, ast, variableType, is50OrHigher);
			}
