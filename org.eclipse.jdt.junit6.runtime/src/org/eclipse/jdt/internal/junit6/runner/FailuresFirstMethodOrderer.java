/*******************************************************************************
 * Copyright (c) 2022, 2025 SpringSource and others.
 *
...
public class FailuresFirstMethodOrderer implements MethodOrderer {
	...
	private final Comparator<MethodDescriptor> comparator= new Comparator<>() {
	...
	public void orderMethods(MethodOrdererContext context) {
		Optional<String> failureNamesParm= context.getConfigurationParameter(JUnit6TestLoader.FAILURE_NAMES);
