...
public class JUnit6TestListener implements TestExecutionListener {
	...
	public void dynamicTestRegistered(TestIdentifier testIdentifier) {
		if (fTestPlan != null) {
			JUnit6Identifier dynamicTestIdentifier= new JUnit6Identifier(testIdentifier);
			boolean hasChildren;
			int testCount;
	...
	private ITestIdentifier getIdentifier(TestIdentifier testIdentifier, boolean ignored, boolean assumptionFailed) {
		...
		return new JUnit6Identifier(testIdentifier);
	}

	private static class IgnoredTestIdentifier extends JUnit6Identifier {
	...
	private static class AssumptionFailedTestIdentifier extends JUnit6Identifier {
